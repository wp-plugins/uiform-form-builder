! function(a) {
    ...
    function d(b) {
        ...
        return c.each(function() {
            var c = a(this),
                d = c.data("slider"),
                e = "object" == typeof b && b;
            d && !e && (e = {}, d.handle1.off(), d.handle2.off(), d.picker.off(), a.each(a.fn.slider.defaults, function(a) {
                e[a] = d[a]
    ...
    var e = {
        ...
        f = function(b, c) {
            ...
            var j = ["round", "triangle", "custom"]; - 1 !== j.indexOf(this.handle) && (this.handle1.addClass(this.handle), this.handle2.addClass(this.handle)), this.offset = this.picker.offset(), this.size = this.picker[0][this.sizePos], this.formater = c.formater, this.tooltip_separator = c.tooltip_separator, this.tooltip_split = c.tooltip_split, this.setValue(this.value), this.handle1.on({
