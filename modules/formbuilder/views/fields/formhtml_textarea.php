       ...
       switch ($help_block['pos']) {
            case 1:
                ...
                <div class="rockfm-input-container">
                    <textarea placeholder="<?php echo $input['placeholder'];?>"
                            class="rockfm-txtbox-inp-val form-control"
                ...
                <div class="rockfm-input-container">
                    <textarea placeholder="<?php echo $input['placeholder'];?>"
                            ...
                            data-placement="bottom"
                             required
                             id="test_field"><?php echo $input['value'];?></textarea>
                </div>
        <?php
    }
...
<div id="rockfm_<?php echo $id;?>"  
     ...
     data-typefield="7" 
     class="rockfm-textarea rockfm-field 
