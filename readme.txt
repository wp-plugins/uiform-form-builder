...
Donate link: http://codecanyon.net/item/uiform-wordpress-form-builder/11057544?ref=Softdiscover
License: GPLv3
...
><strong>Uiform Form Builder Premium</strong><br>
>If you like Uiform Form Builder Express, you might want to give our premium offering a try. All features locked on express version are unlocked on premium version:
>
...
>
>Try out [Uiform Form Builder Premium](http://codecanyon.net/item/uiform-wordpress-form-builder/11057544?ref=Softdiscover)
...
= Via FTP =
1. After your download unzip `Uiform form Builder` from your download .zip
2. Open your FTP client
3. Upload the `Uiform form Builder` folder to /wp-content/plugins/ directory on your hosting server
4. Activate the Uiform Form Builder plugin through the 'Plugins' menu in WordPress
5. Configure the plugin by going to the `Uiform Form Builder` menu that appears in your admin menu
...
6. After the plugin has been activated you will notice a new menu item on the left hand navigation labelled Uiform Express

== Frequently Asked Questions ==

= How do I create a form? =

1. Click on the Uiform Express menu > click on add new form button
...
= 1.3.2 =
* Fixed bug related to dynamic highlight when validating
= 1.3.3 =
* Fixed bug related to report when names have quotes
= 1.3.4 =
* Fixed bug related to report
= 1.3.5 =
* added recover option when loading old forms
* listing forms was not working properly
* fixed bug related to not saved preview on backend
* added lzstring to compress html code. impressive compression
* deprecated functions to php5.5, 5.6
= 1.3.6 =
* Fixed bug when loading plugin
= 1.3.7 =
